...
export const dictionaries = {
  zh: {
    ...
    peerSite: "Quartz 版",
    peerSiteIntro: "同一知识库的另一种呈现：",
    friendLinks: "友链",
    footerNote: "One Blog · 由 Obsidian 知识库发布",
  ...
  en: {
    ...
    peerSiteIntro: "Another view of the same vault:",
    friendLinks: "Friend links",
    footerNote: "One Blog · Published from an Obsidian vault",
